...
interface BadgeProps {
  ...
  /** The size of badge. It can be "xSmall", "small", "medium",or "large". Default is "medium". */
...
> = (props, ref) => {
  ...
  return (
    <>
      <span className="relative" ref={ref} {...restProps} >
        {children}
        <div
 ...
 */
export const CounterBadge = React.forwardRef<HTMLSpanElement, BadgeProps>(
  InternalBadge,
)